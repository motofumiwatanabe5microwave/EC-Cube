...
if (!class_exists('\Eccube\Entity\Shipping')) {
    ...
    class Shipping extends \Eccube\Entity\AbstractEntity
    {
        ...
        public function setFromCustomerAddress(CustomerAddress $CustomerAddress)
        {
            ...
            ->setPhoneNumber01($CustomerAddress->getPhoneNumber01())
            ->setPhoneNumber02($CustomerAddress->getPhoneNumber02())
            ->setPhoneNumber03($CustomerAddress->getPhoneNumber03())
        ...
        public function clearCustomerAddress()
        {
            ...
            ->setCompanyName(null)
            // feature-002 電話番号設定変更 項目変更
            ->setPhoneNumber01(null)
            ->setPhoneNumber02(null)
            ->setPhoneNumber03(null)
            ->setPostalCode(null)
            ->setPref(null)
            ->setAddr01(null)
            ->setAddr02(null);
